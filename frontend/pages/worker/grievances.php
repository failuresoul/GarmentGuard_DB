    ...
    <div class="modal-box">
      <div class="modal-header">
        ...
        <button class="close-btn"
          onclick="document.getElementById('submit-modal').classList.remove('open')">&times;</button>
      </div>
      <form id="submit-grievance-form" onsubmit="submitGrievance(event)" style="display: contents;">
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="sg-worker" name="worker_id" placeholder="Enter your Worker ID"
              required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="sg-description" name="description" rows="4"
              placeholder="Detail the complaint (minimum 20 characters)..." required></textarea>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary"
            onclick="document.getElementById('submit-modal').classList.remove('open')">Cancel</button>
